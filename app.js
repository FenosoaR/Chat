// yarn add express express-ejs-layouts bcryptjs passport passport-local mysql2 connect-flash express-session socket.io 
//nodemon sequelize-cli ejs express-fileupload sequelize
...
io.on('connection' ,(socket) =>{
    ...
    socket.on('send-message' , async(message ,me,receiver_id,room)=> {
        ...
        // socket.broadcast.emit('conversation',message,user,room)
